pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~snow.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~snow.adb");
...
package body ada_main is
   ...
   E82 : Short_Integer; pragma Import (Ada, E82, "interfaces__c__strings_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_snow");
